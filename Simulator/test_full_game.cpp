...
int main() {
    ...
    std::cout << "  - GameManager factories: " << gameManagerFactories->size() << std::endl;
    std::cout << "  - Player factories: " << playerFactories->size() << std::endl;
    std::cout << "  - TankAlgorithm factories: " << tankAlgorithmFactories->size() << std::endl;
    ...
    std::cout << "Libraries: Loaded successfully" << std::endl;
    std::cout << "Factories: Available in registries" << std::endl;
