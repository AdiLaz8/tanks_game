...
int main() {
    std::cout << "=== RUNNING SINGLE GAME WITH WORKING FACTORIES ===" << std::endl;
    ...
    // Run the game using GameRunner::runSingleGame
    ...
    try {
        ...
        if (execution.success) {
            ...
            std::cerr << "❌ Game execution failed: " << execution.errorMessage << std::endl;
            return 1;
        }
