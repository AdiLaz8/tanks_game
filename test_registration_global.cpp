...
int main() {
    std::cout << "Testing Registration System (Global Loading)..." << std::endl;
    
    // Load GameManager library with RTLD_GLOBAL to ensure global constructors are called
    ...
    // Load Algorithm library with RTLD_GLOBAL
